...
async def pause(client: Client, message: Message):
    ...
    await message.reply_text("⏸ Lagu Kamu Sudah Diberhentikan!.")
...
async def resume(client: Client, message: Message):
    ...
    await message.reply_text("▶️ Lagu Kamu Sudah Di-Lanjutkan!.")
...
async def stop(client: Client, message: Message):
    ...
    await message.reply_text("⏹ Maaf Aku Ter-Putus Dari Voice Chat Grup!.")
...
async def skip(client: Client, message: Message):
    ...
    await message.reply_text("⏩ Lanjut Ke Lagu Berikutnya Beb!.")
